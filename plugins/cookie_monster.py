# -*- coding: utf-8 -*-
"""mention cookie - get cookie monster"""
...
def image(searchterm, unsafe=False):
    ...
    searchurl = "https://www.google.com/search?tbm=isch&q={0}{1}"\
        .format(searchterm, safe)
...
def on_message(msg, server):
    text = msg.get("text", "")
    match = re.findall(r"(cookie)|(kuki)|(kolac)", text)
    if not match:
        return

    searchterm = u'cookie monster'
